...
@Gtk.Template(resource_path='/io/github/gustavoperedo/VideoDownloader/window.ui')
class Window(Handy.ApplicationWindow):
    __gtype_name__ = 'VideoDownloaderWindow'
    settings = Gio.Settings.new('io.github.gustavoperedo.VideoDownloader')
    ...
    def on_about(self, *args, **kwargs):
        ...
        dialog.props.logo_icon_name = 'io.github.gustavoperedo.VideoDownloader'
    ...
    def setup_css(self, *args, **kwargs):
        ...
        uri = 'resource:///io/github/gustavoperedo/VideoDownloader/style.css'
